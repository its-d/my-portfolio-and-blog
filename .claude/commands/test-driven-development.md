...
npm test path/to/test.test.ts
```
Confirm: test passes, other tests still pass, output is clean.
...
Tests written after code pass immediately. Passing immediately proves nothing — might test wrong thing, might miss edge cases.
